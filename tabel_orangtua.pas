...
begin
if (Edit1.Text= '') or (Edit2.Text ='') or (Edit3.Text= '') or (Edit4.Text ='') or (Edit5.Text ='') or (cbb1.Text ='') or (Edit6.Text ='') or (Edit7.Text ='') or  (cbb2.Text ='') or(cbb3.Text ='')then
begin
...
ZQuery1.SQL.Clear;
ZQuery1.SQL.Add('Update table_orangtua set id_orangtua="'+Edit1.Text+'",nik ="'+Edit2.Text+'",nama_orangtua="'+Edit3.Text+'",jenis_kelamin="'+cbb1.Text+'",alamat="'+Edit4.Text+'",telepon="'+Edit5.Text+'",pendidikan="'+Edit7.Text+'",pekerjaan="'+Edit6.Text+'",agama="'+cbb2.Text+'",status="'+cbb3.Text+'" where id_orangtua="'+Edit1.Text+'"');
ZQuery1. ExecSQL;
...
begin
ZQuery1.SQL.Clear;
ZQuery1.SQL.Add(' delete from table_orangtua where id_orangtua="'+Edit1.Text+'"');
ZQuery1.ExecSQL;
ZQuery1.SQL.Clear;
ZQuery1.SQL.Add('select * from table_orangtua');
ZQuery1.Open;
